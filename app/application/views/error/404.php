...
<body>
	<div class="wrapper">
		...
		<div role="main" class="main">
			<?php $messages = array('You made Invalid Request.', 'Insufficient permisions', 'You took a wrong turn.'); ?>
			...
			<p>
				Go Back to Inventory List Page using this <?php echo HTML::link('/', 'home page'); ?>? Link
			</p>
		</div>
	</div>
</body>
